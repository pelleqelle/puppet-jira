      ...
      on_supported_os.each do |os, facts|
        context "on #{os} #{facts}" do
          ...
          context 'default params' do
            ...
            it do
              expected.to contain_file('/opt/jira/atlassian-jira-6.3.4a-standalone/bin/setenv.sh').
                with_content(%r{#DISABLE_NOTIFICATIONS=})
            end
            it { expected.to contain_file('/opt/jira/atlassian-jira-6.3.4a-standalone/bin/user.sh') }
            it { expected.to contain_file('/opt/jira/atlassian-jira-6.3.4a-standalone/conf/server.xml') }
            it do
              expected.to contain_file('/home/jira/dbconfig.xml').
                with_content(%r{jdbc:postgresql://localhost:5432/jira}).
                with_content(%r{<schema-name>public</schema-name>})
            end
            it { expected.to_not contain_file('/home/jira/cluster.properties') }
          end
          ...
          context 'mysql params' do
            ...
            it { expected.to contain_file('/opt/jira/atlassian-jira-6.3.4a-standalone/bin/setenv.sh') }
            it { expected.to contain_file('/opt/jira/atlassian-jira-6.3.4a-standalone/bin/user.sh') }
            it { expected.to contain_file('/opt/jira/atlassian-jira-6.3.4a-standalone/conf/server.xml') }
            it do
              expected.to contain_file('/home/jira/dbconfig.xml').
          ...
          context 'customise tomcat connector' do
            ...
            it do
              expected.to contain_file('/opt/jira/atlassian-jira-6.3.4a-standalone/conf/server.xml').
          ...
          context 'server.xml 7 listeners' do
            ...
            it do
              expected.to contain_file('/opt/jira/atlassian-jira-software-7.0.4-standalone/conf/server.xml').
          ...
          context 'context resources' do
            ...
            it do
              expected.to contain_file('/opt/jira/atlassian-jira-6.3.4a-standalone/conf/context.xml').
          ...
          context 'enable secure admin sessions' do
            ...
            it do
              expected.to contain_file('/home/jira/jira-config.properties').
          ...
          context 'enable clustering' do
            ...
            it do
              expected.to contain_file('/home/jira/cluster.properties').
