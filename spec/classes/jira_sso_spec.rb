      ...
      on_supported_os.each do |os, facts|
        context "on #{os} #{facts}" do
          ...
          context 'default params' do
            ...
            it { expected.to contain_file('/opt/jira/atlassian-jira-6.3.4a-standalone/atlassian-jira/WEB-INF/classes/seraph-config.xml') }
            it { expected.to contain_file('/opt/jira/atlassian-jira-6.3.4a-standalone/atlassian-jira/WEB-INF/classes/crowd.properties') }
          end
          context 'with param application_name set to appname' do
            ...
            it do
              expected.to contain_file('/opt/jira/atlassian-jira-6.3.4a-standalone/atlassian-jira/WEB-INF/classes/crowd.properties').
          ...
          context 'with param application_login_url set to ERROR' do
            ...
            it('fails') do
              expected.to raise_error(Puppet::Error, %r{does not match})
            end
          end
